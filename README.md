...
resource "ravendb_server" "server" {
  ...
  database           = "firewire"
  unsecured          = true
  setup_package_zip  = "/path/to/cluster/setup.zip"
  package {
    version = "5.2.2"
  }
  url {
...
| setup_package_zip - `optional`                                                                                                                                                                                                                                                | The cluster setup zip file that is used by RavenDB for setup secured cluster.                                                 | `string`                                                                                                                                                                                                                                                            |       no |
